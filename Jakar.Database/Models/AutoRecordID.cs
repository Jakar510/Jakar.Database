    ...
    where TSelf : TableRecord<TSelf>, ITableRecord<TSelf>
{
    ...
    [Pure] public static AutoRecordID<TSelf>? TryCreate( NpgsqlDataReader      reader, string propertyName ) => TryCreate(reader.GetFieldValue<long?>(TSelf.MetaData[propertyName].Index));
    [Pure] public static AutoRecordID<TSelf>  Create( NpgsqlDataReader         reader, string propertyName ) => Create(reader.GetFieldValue<long>(TSelf.MetaData[propertyName].Index));
