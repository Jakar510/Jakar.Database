...
{
    public virtual ValueTask<ErrorOrResult<TSelf>> TryGetSubscription<TSelf>( DbConnectionContext context, UserRecord record, CancellationToken token = default )
        where TSelf : UserSubscription<TSelf>, ITableRecord<TSelf> => new(Error.NoContent());


    public virtual ValueTask<ErrorOrResult<SubscriptionInfo>> ValidateSubscription( DbConnectionContext context, UserRecord record, CancellationToken token = default ) => new(new SubscriptionInfo(SubscriptionState.NotSet, SubscriptionStatus.NotSet, record.SubscriptionExpires));


    protected virtual async ValueTask<ErrorOrResult<UserRecord>> VerifyLogin( DbConnectionContext context, ILoginRequest request, CancellationToken token = default )
    {
    ...
    public virtual async ValueTask<ErrorOrResult<TValue>> Verify<TValue>( DbConnectionContext context, ILoginRequest request, Func<DbConnectionContext, UserRecord, ErrorOrResult<TValue>> func, CancellationToken token = default )
    {
        ErrorOrResult<UserRecord> loginResult = await VerifyLogin(context, request, token);
    ...
    public virtual async ValueTask<ErrorOrResult<TValue>> Verify<TValue>( DbConnectionContext context, ILoginRequest request, Func<DbConnectionContext, UserRecord, CancellationToken, ValueTask<ErrorOrResult<TValue>>> func, CancellationToken token = default )
    {
        ErrorOrResult<UserRecord> loginResult = await VerifyLogin(context, request, token);

        return loginResult.TryGetValue(out UserRecord? record, out Errors? errors)
                   ? await func(context, record, token)
                   : errors;
    }

    public virtual async ValueTask<ErrorOrResult<TValue>> Verify<TValue>( DbConnectionContext context, ILoginRequest request, Func<DbConnectionContext, UserRecord, CancellationToken, Task<ErrorOrResult<TValue>>> func, CancellationToken token = default )
    {
        ErrorOrResult<UserRecord> loginResult = await VerifyLogin(context, request, token);
    ...
    public virtual async ValueTask<ErrorOrResult<SessionToken>> Verify( DbConnectionContext context, ILoginRequest request, ClaimType types, CancellationToken token = default )
    {
        ErrorOrResult<UserRecord> loginResult = await VerifyLogin(context, request, token);
    ...
    protected virtual async ValueTask<ErrorOrResult<UserRecord>> VerifyLogin( DbConnectionContext context, string jsonToken, ClaimType types = DEFAULT_CLAIM_TYPES, CancellationToken token = default )
    {
        ...
        ErrorOrResult<UserRecord> result = await UserRecord.TryFromClaims(context, this, claims.AsValueEnumerable(), types | DEFAULT_CLAIM_TYPES, token);
    ...
    public virtual async ValueTask<Permissions<TEnum>> GetRights<TEnum>( DbConnectionContext context, RecordID<UserRecord> userID, CancellationToken token )
        where TEnum : unmanaged, Enum
    {
        ...
        try
        {
            ...
            await foreach ( string line in context.QueryAsync<string>(command, token) )
            {
                Permissions<TEnum> other = Permissions<TEnum>.Create(line);
                result |= other;
            }
    ...
    public virtual async ValueTask<ErrorOrResult<SessionToken>> Register<TUser>( DbConnectionContext context, ILoginRequest<TUser> request, CancellationToken token = default )
        where TUser : class, IUserData<Guid>, IUserDetails
    {
        ...
        return await GetToken(context, record, DEFAULT_CLAIM_TYPES, token);
    }
    ...
    public ValueTask<ErrorOrResult<TValue>> Verify<TValue>( ILoginRequest request, Func<DbConnectionContext, UserRecord, ErrorOrResult<TValue>>                               func, CancellationToken token = default ) => this.TryCall(Verify, request, func, token);
    public ValueTask<ErrorOrResult<TValue>> Verify<TValue>( ILoginRequest request, Func<DbConnectionContext, UserRecord, CancellationToken, ValueTask<ErrorOrResult<TValue>>> func, CancellationToken token = default ) => this.TryCall(Verify, request, func, token);
    public ValueTask<ErrorOrResult<TValue>> Verify<TValue>( ILoginRequest request, Func<DbConnectionContext, UserRecord, CancellationToken, Task<ErrorOrResult<TValue>>>      func, CancellationToken token = default ) => this.TryCall(Verify, request, func, token);
}
