...
public sealed record UserRecord : OwnedTableRecord<UserRecord>, ITableRecord<UserRecord>, IRefreshToken, IUserDataRecord, IUserID
{
    ...
    public static TableMetaData PropertyMetaData { get; } = SqlTable<UserRecord>.Default.With_AdditionalData()
                                                                                .With_CreatedBy()
                                                                                ...
                                                                                .WithColumn<SupportedLanguage>(nameof(PreferredLanguage),   ColumnOptions.None)
